...
--local themes = {}
local theme = {
    accent = Color3.fromRGB(200, 62, 100),
...
do
    ...
    function library:New(info)
        ...
        function window:Watermark(info)
            ...
            --
            local info = info or {}
            local watermark_name = info.name or info.Name or info.title or info.Title or string.format("$$ stumware || uid : %u || ping : %u || fps : %u", 1, 100, 200)
            --
            ...
            local watermark_title = utility:Create("TextLabel", {Vector2.new(2 + 6,4), watermark_outline}, {
                Text = string.format("stumware - fps : %u - uid : %u", 35, 2),
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
                OutlineColor = theme.textborder,
            ...
            --
            watermark_title.Text = string.format("$$ stumware || uid : %u || ping : %i || fps : %u", 1, tostring(library.shared.ping), library.shared.fps)
